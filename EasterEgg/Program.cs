...
namespace EasterEgg
{
    public class Program
    {
        public static void Main()
        {
            ...
            const string MsgIntroduceNameModify = "Introdueix el seu nom, (en cas de equivocar-te amb el nom, et retorna el personatje per defecte i com no es pot moficar, sortiras al programa principal):";
